 ...
 * @author lucas
 */
public class FenetreAjoutRealisation extends javax.swing.JDialog {
    ...
    public FenetreAjoutRealisation(java.awt.Frame parent, Realisation laRealisation, ModelJTable modelTableVip, ModelJTableFilm modelTableFilm) {
        super(parent, true);
        try {
            modal = false;
            this.laRealisation = laRealisation;
    ...
    private void initComponents() {
        ...
        lbTitre.setText("AJOUT REALISATION FILM");
    ...
    private void btAjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAjouterActionPerformed
        ...
        laRealisation.setNumVisa(numVisa);
        laRealisation.setNumVip(numVip);
